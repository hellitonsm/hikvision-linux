...
if (m_pbframe.winId() == 0) {
        QMessageBox::warning(this, tr("Playback error"), tr("Video display widget is unavailable."));
        return;
    }
...
void PlayBack::on_pushButton_playback_start_2_clicked()
{
    ...
    // Guard against playing into a destroyed widget
if (m_pbframe.winId() != 0) {
...
void PlayBack::on_pushButton_3_save_clicked()
{
	if (m_pbsaving == 0)
	{
		...
		ui.pushButton_3_save->setText(QApplication::translate("translateClass", 
			"\345\201\234\346\255\242\344\277\235\345\255\230", 0, 0));
	}
	else
	{
		if (!NET_DVR_StopPlayBackSave(m_pbhandle))
