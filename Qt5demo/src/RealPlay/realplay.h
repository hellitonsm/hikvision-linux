...
public:
    ...
    void startZeroChannelRealPlay();
    void stopZeroChannelRealPlay();
    int  startZeroChannelRealPlayEncapseInterface(int devicerow);
    void stopZeroChannelRealPlayEncapseInterface(int devicerow);
...
private slots:
    ...
    void on_pushButton_zerochannel_clicked();
...
private:
    ...
    // Channel Zero
    int m_rpzerochannelflag;
    LONG m_rpzerochannelhandle;
    int m_rpzerochanneldevicerow;
	//int m_rperrorflag;
};
#endif // REALPLAY_H
