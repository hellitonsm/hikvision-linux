...
void DeviceData::setEncryptionKey(QString key)
{
    m_qencryptionkey = key;
}

QString DeviceData::getEncryptionKey()
{
    return m_qencryptionkey;
}

int DeviceData::getZeroChanNum() const
{
    return m_izerochenum;
}

void DeviceData::setZeroChanNum(int num)
{
    m_izerochenum = num;
}

bool DeviceData::isZeroChanSupported() const
{
    return m_izerochenum > 0;
}
